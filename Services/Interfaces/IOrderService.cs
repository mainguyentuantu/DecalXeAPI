...
namespace DecalXeAPI.Services.Interfaces
{
    public interface IOrderService
    {
        ...
        // Phương thức lấy dữ liệu form tạo đơn hàng
        Task<OrderCreateFormDataDto> GetOrderCreateFormDataAsync();

        // Phương thức theo dõi đơn hàng
        Task<IEnumerable<OrderTrackingDto>> GetOrderTrackingAsync(string? orderId, string? customerPhone, string? licensePlate);
    }
}