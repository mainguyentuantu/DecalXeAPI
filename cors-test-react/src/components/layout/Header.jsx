...
const Header = ({ onMenuClick }) => {
  ...
  const notifications = [
    { id: 1, message: 'Đơn hàng mới từ khách hàng Nguyễn Văn A', time: '5 phút trước', unread: true },
    { id: 2, message: 'Thiết kế #DXE-001 đã được duyệt', time: '1 giờ trước', unread: true },
    { id: 3, message: 'Thanh toán đơn hàng #ORD-123 thành công', time: '2 giờ trước', unread: false },
  ];
