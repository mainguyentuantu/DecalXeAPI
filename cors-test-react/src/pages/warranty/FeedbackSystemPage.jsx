...
const FeedbackSystemPage = () => {
    ...
    const mockFeedbacks = [
      {
        ...
        content: 'Nhân viên phục vụ rất nhiệt tình, chất lượng decal rất tốt. Tôi rất hài lòng với dịch vụ.',
        status: 'resolved',
      ...
      },
      {
        ...
        content: 'Decal đẹp, bền màu. Tuy nhiên thời gian giao hàng hơi chậm một chút.',
        status: 'pending',
      ...
      },
      {
        ...
        content: 'Đơn hàng bị chậm trễ nhiều so với cam kết. Cần cải thiện thời gian giao hàng.',
        status: 'in_progress',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selectedFeedback) {
        await warrantyService.updateFeedback(selectedFeedback.feedbackID, formData);
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Hệ Thống Phản Hồi</h1>
          <p className="mt-2 text-gray-600">Quản lý và xử lý phản hồi từ khách hàng</p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">Danh Sách Phản Hồi</h3>
          </div>
                  ...
                  return (
                    <tr key={feedback.feedbackID} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getTypeColor(feedback.feedbackType)}`}>
            ...
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
              <div className="mt-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Loại Phản Hồi</label>
                    <select
