...
const SupportTicketPage = () => {
    ...
    const mockTickets = [
      {
        ...
        description: 'Decal tôi mua cách đây 1 tháng bị bong tróc ở một số chỗ. Cần hỗ trợ kiểm tra và thay thế.',
        priority: 'high',
        category: 'warranty',
        status: 'open',
        assignedTo: 'EMP001',
      ...
      },
      {
        ...
        description: 'Tôi muốn tư vấn về các mẫu decal mới cho xe tải của mình. Có thể gọi điện tư vấn không?',
        priority: 'medium',
      ...
      },
      {
        ...
        description: 'Đơn hàng ORD003 của tôi đã quá hạn giao hàng 3 ngày. Cần kiểm tra và thông báo tình trạng.',
        priority: 'high',
        category: 'order',
        status: 'resolved',
        assignedTo: 'EMP003',
      ...
      },
      {
        ...
        description: 'Tôi cần báo giá cho dịch vụ thiết kế và in decal cho 5 xe tải. Vui lòng liên hệ sớm.',
        priority: 'low',
        category: 'quotation',
        status: 'closed',
        assignedTo: 'EMP001',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selectedTicket) {
        await warrantyService.updateSupportTicket(selectedTicket.ticketID, formData);
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Quản Lý Ticket Hỗ Trợ</h1>
          <p className="mt-2 text-gray-600">Theo dõi và xử lý các yêu cầu hỗ trợ từ khách hàng</p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">Danh Sách Ticket</h3>
          </div>
