    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Quản lý và xử lý các giao dịch thanh toán</p>
        </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {payments.map((payment) => {
                  ...
                  const customer = order ? getCustomerInfo(order.customerID) : null;
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(payment.paymentStatus)}`}>
                          {payment.paymentStatus === 'completed' ? 'Hoàn thành' :
                           ...
                           payment.paymentStatus === 'failed' ? 'Thất bại' : payment.paymentStatus}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ...
                    >
                      ...
                      {orders.map(order => (
                        <option key={order.orderID} value={order.orderID}>
                          {order.orderID} - {getCustomerInfo(order.customerID)?.fullName}
                        </option>
                      ))}
                    </select>
                  </div>
