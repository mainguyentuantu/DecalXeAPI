  ...
  const stageHistory = [
    {
      ...
      description: 'Đơn hàng được tạo và tiếp nhận'
    },
    {
      stage: 'Survey',
      status: 'completed',
      date: '2024-01-15T10:00:00Z',
      description: 'Khảo sát xe và yêu cầu khách hàng'
    },
    {
      stage: 'Designing',
      status: 'current',
      date: '2024-01-15T14:00:00Z',
      description: 'Đang thiết kế mẫu decal'
    },
    {
      stage: 'Production',
      status: 'pending',
      date: null,
      description: 'Sản xuất và thi công'
    },
    {
      stage: 'Delivery',
      status: 'pending',
      date: null,
      description: 'Nghiệm thu và bàn giao'
    }
  ];
